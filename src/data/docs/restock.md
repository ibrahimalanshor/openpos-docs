---
title: Cara Membuat Restok Barang ke Supplier
slug: cara-membuat-restock-barang
summary: Cara membuat restock barang ke supplier di toko lewat aplikasi.
order: 5
parent: mengelola-stok
---

Restok barang adalah cara untuk membuat pembelian barang ke supplier untuk menambahkan stok barang.
...
Jika ingin menggunakan barcode scanner, klik kotak input pencarian barang dan scan barang yang direstok.

Setelah barang ditambahkan/discan, barang akan masuk ke daftar barang yang di restok.

Untuk menambahkan jumlahnya, bisa ditambahkan ulang atau discan ulang di kotak input pencarian barang.

Atau bisa diketikan langsung di kotak jumlah barangya.
